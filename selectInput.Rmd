---
title: "Video Games Sales - SelectInput"
output: 
...
df2 <- df %>% 
  ...
  ggplot()+
  geom_point(aes(x=NA_Sales, y=EU_Sales))+facet_wrap(~Platform)+labs(title="PS3 and Xbox One Sales by Location")
ggplotly(df2)})
...
df4 = df %>% 
  filter(decade==input$decade_input) %>%
  filter(Platform!='2600',Platform!='GC',Platform!='DC',Platform!="N64",Platform!='PSP',Platform!='PSV') %>% 
